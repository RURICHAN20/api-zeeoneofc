...
var creatorList = ['@zahirrr','@zhirrrgans','@zhirr_ajalah','@zahiranjay', '@RURIBOTZsss','@zhirrganteng','@zahirrgantengg'];
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'RURIBOTZ') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'RURIBOTZ') return res.json(loghandler.invalidKey)
